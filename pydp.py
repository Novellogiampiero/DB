...
class db():
    def __init__(self,hosts="10.16.1.208",database="novello",user='novello',password='novello',ports='5432'):
        self.hosts=hosts
    ...
    def InsertJsonRawInTable(self,tablename,filename):
        ...
        index=1
        self.sql = ("INSERT INTO %s VALUES (1,2,'%s');"%(tablename,jdata))
